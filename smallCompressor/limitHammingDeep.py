...
bitVectors,POSs,refs,alts,sampleNames = cl.readVcfgzToBitVectors(filename
                                        ='gene1000chr22.vcf.gz',startPos=16050075,
                                        endPos=16500000)

colBitVecs = cl.columnToRow(bitVectors)
# Console1 limit=2000,resetValue=10; Console2 limit=1000,resetValue=10; Console3 limit = 2000,resetValue=5;Console4 limit=600,resetValue=10
#%%
# Inputs bitVectors
...
depth = 0.4 
finalDepth = 2
depthGrowth = 0.2 # How much the depth of searching grows, once the searching is reset
# An imperical setting, threshold for the profit rate, profit/cost
iniThresh = int(length/3500)*100 
# How much the threshold decreases, once the searching is reset
threshDecay = depthGrowth/4*iniThresh 
...
#                    sys.exit()
            ...
            if failCounter >= amountBitVecs-1:
                failCounter = 0
...
allUnfitPos.dump('unfitPosDeep.dat')
allFitPos.dump('fitPosDeep.dat')
